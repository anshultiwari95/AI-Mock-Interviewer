    ...
    <section className="bg-white">
      <div className="relative lg:grid lg:min-h-screen lg:grid-cols-12">
        ...
        <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
          <img
            alt=""
            src="https://www.dice.com/binaries/medium/content/gallery/dice/insights/2022/08/shutterstock_510170158.jpg"
          ...
          <div className="hidden lg:relative lg:block lg:p-12">
            ...
            <p className="mt-4 leading-relaxed text-white">
              ...
              Get instant AI feedback to improve your answers.
            </p>
          </div>
        </section>
